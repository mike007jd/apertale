...
6. Only after the complete art set exists, transfer generated finals through the supported host path with `assetUse: "book-art"`. When direct transfer is unavailable, call `request_image_handoff` and wait for the reader's result.
