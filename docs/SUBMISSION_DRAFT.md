...
Codex calls `sketch_storyboard`. On the right, pencil marks appear one after another on the real paper: a box labelled `boat`, an ellipse labelled `lighthouse`, an arrow for the wind, a working title. Step through the four spreads with the storyboard arrows.
